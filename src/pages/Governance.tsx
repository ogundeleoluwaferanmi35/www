...
export default function Governance() {
  const maintainerRoles = ['Founder & Protocol Architect', 'Lead Engineer', 'Cryptography Engineer'];
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-heading font-semibold mb-4 text-on-surface">Decision-Making Process</h2>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-heading font-semibold mb-4 text-on-surface">Maintainer List</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {maintainers.map((maintainer) => (
            <div key={maintainer.name} className="border border-outline-variant/40 bg-surface-container p-4 rounded-lg flex items-center gap-4">
              <img src={maintainer.photo} alt={maintainer.name} className="w-16 h-16 rounded-full object-cover" />
              <div>
                ...
                {maintainer.github && (
                  <a href={maintainer.github} target="_blank" rel="noopener noreferrer" className="text-[13px] text-on-surface hover:text-on-surface-variant transition-colors hover:underline">
                    GitHub
                  </a>
                )}
              </div>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-heading font-semibold mb-4 text-on-surface">Wave Scoping Process</h2>
        <p className="font-body text-[15px] leading-relaxed text-on-surface-variant mb-4">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-heading font-semibold mb-4 text-on-surface">Dispute & Escalation Path</h2>
        <p className="font-body text-[15px] leading-relaxed text-on-surface-variant mb-4">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-heading font-semibold mb-4 text-on-surface">Mainnet Parameter Change Process</h2>
        <p className="font-body text-[15px] leading-relaxed text-on-surface-variant mb-4">
      ...
      <section className="mb-12">
        ...
        <p className="font-body text-[15px] leading-relaxed text-on-surface-variant mb-4">
          Interested in contributing or applying for funding? Check out our <Link to="/grants" className="text-on-surface hover:text-on-surface-variant transition-colors underline decoration-outline-variant/40 underline-offset-4">Grants</Link> program and see our <Link to="/contributors" className="text-on-surface hover:text-on-surface-variant transition-colors underline decoration-outline-variant/40 underline-offset-4">Contributors</Link> page.
        </p>
      </section>
    </div>
  );
